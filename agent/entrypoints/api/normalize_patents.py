...
from agent.domain.evaluation.normalization import normalize_pat, PATENT_PATTERN as PATENT_RE
from agent.entrypoints.api.get_ucid import select_best_ucid
